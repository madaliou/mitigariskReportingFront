    ...
    // =============================================================================
      ...
      children: [
        ...
        // },
        {
          ...
          name: 'dashboard',
          beforeEnter: ifAuthenticated,
          component: () => import('./views_prendtacom/dashboard/dashboard.vue'),
          meta: {
            rule: 'editor'
          }
        },
        ...
        // =============================================================================
        // ------- Start Prend Ta Com Application Routes -------------------------------
        // =============================================================================
        {
          path: '/base/biens',
          beforeEnter: ifAuthenticated,
          name: 'base-biens',
          component: () => import('@/views_prendtacom/recipients/DataListListView'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Biens', active: true }
            ],
            pageTitle: 'Biens',
            rule: 'editor'
          }
        },
        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-familles',
          component: () => import('@/views_prendtacom/familles/DataListFamille'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Familles', active: true }
            ],
            pageTitle: 'Familles',
            rule: 'editor'
          }
        },
        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-ecarts',
          component: () => import('@/views_prendtacom/ecarts/DataListEcarts'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Ecarts', active: true }
            ],
            pageTitle: 'Ecarts',
            rule: 'editor'
          }
        },
        {
          ...
          component: () => import('@/views_prendtacom/validation/DataListValidation'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Validations', active: true }
            ],
        ...
        {
          path: '/base/Biens-nouveaux',
          beforeEnter: ifAuthenticated,
          name: 'base-Biens-nouveaux',
          component: () => import('@/views_prendtacom/Codification/DataListListView'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Biens nouveaux', active: true }
            ],
            pageTitle: 'Biens nouveaux',
            rule: 'editor'
          }
        },

        {
          path: '/base/codification',
          beforeEnter: ifAuthenticated,
          name: 'base-codification',
          component: () => import('@/views_prendtacom/CodificationCode/DataCodificationListView'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Codification', active: true }
            ],
            pageTitle: 'Codification',
            rule: 'editor'
          }
        },

        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-etiqueter',
          component: () => import('@/views_prendtacom/Etiquette/DataListEtiqueterView'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Biens étiquetés', active: true }
            ],
            pageTitle: 'Biens étiquetés',
            rule: 'editor'
          }
        },
        {
          path: '/base/nonetiqueter',
          beforeEnter: ifAuthenticated,
          name: 'base-nonetiqueter',
          component: () => import('@/views_prendtacom/Etiquette/DataListNonEtiqueterView'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Biens non étiquetés', active: true }
            ],
            pageTitle: 'Biens non étiquetés',
            rule: 'editor'
          }
        },
...

        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-users',
          component: () => import('@/views_prendtacom/users/DataListListView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
        ...
        },
        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-locality',
          component: () => import('@/views_prendtacom/Locality/DataListLocality'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Localités', active: true }
            ],
            pageTitle: 'Localités',
            rule: 'editor'
          }
...

        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-regions',
          component: () => import('@/views_prendtacom/regions/DataListRegion'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Régions', active: true }
            ],
            pageTitle: 'Régions',
            rule: 'editor'
          }
...

        {
          ...
          beforeEnter: ifAuthenticated,
          name: 'base-sites',
          component: () => import('@/views_prendtacom/sites/DataListSite'),
          meta: {
            breadcrumb: [
              { title: 'Tableau de bord', url: '/' },
              { title: 'Sites', active: true }
            ],
            pageTitle: 'Sites',
            rule: 'editor'
          }
        ...
        // =============================================================================
        // ------- End Prend Ta Com Application Routes -------------------------------
        // =============================================================================
