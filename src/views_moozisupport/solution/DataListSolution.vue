<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" pagination :max-items="itemsPerPage" search :data="solutions">
      ...
      <div slot="header" class="flex flex-wrap-reverse items-center flex-grow justify-between">
        ...
        <vs-dropdown vs-trigger-click class="cursor-pointer mb-4 mr-4 items-per-page-handler">
          <div class="p-4 border border-solid d-theme-border-grey-light rounded-full d-theme-dark-bg cursor-pointer flex items-center justify-between font-medium">
            <span class="mr-2">{{ currentPage * itemsPerPage - (itemsPerPage - 1) }} - {{ solutions.length - currentPage * itemsPerPage > 0 ? currentPage * itemsPerPage : solutions.length }} of {{ queriedItems }}</span>
      ...
      <template slot="thead">
        <vs-th sort-key="nom">Solution</vs-th>
...
import DataViewSidebar from './DataViewSidebarSolution'
...
export default {
  ...
  computed: {
    ...
    queriedItems () {
      return this.$refs.table ? this.$refs.table.queriedResults.length : this.solutions.length
    }
  },
  methods: {
    addNewData () {
        ...
        accept: async () => {
          ...
          this.$http.delete(`solutions/${id}/`)
            .then(response => {
              ...
              window.getPrendTaCom.success('La solution est supprimée avec succès.', response)
            })
            .catch(() => {
