...
<!--            <feather-icon v-if="profile_moov!=='studio'" style="color: red"  icon="TrashIcon" svgClasses="w-5 h-5 hover:text-danger stroke-current" class="ml-2" @click.stop="deleteData(tr.id)" />-->
  ...
  watch: {
    famille (value) {
      ...
      if (value) {
        ...
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', { familyNew, domain, siteNew, regionNew   })
          .then((response) => {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', { domain, siteNew, regionNew   })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    domaine (value) {
      ...
      if (value) {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', { domain, familyNew, siteNew, regionNew  })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const siteNew = this.site
        const regionNew = this.region
        this.$http.post('codifiedFoundProperties-filter/', { familyNew, siteNew, regionNew  })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    site (value) {
      ...
      if (value) {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', { siteNew, domain, familyNew, regionNew })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', { domain, familyNew, regionNew })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    region (value) {
      ...
      if (value) {
        ...
        const familyNew = this.famille
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', { regionNew, siteNew, domain, familyNew})
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const familyNew = this.famille
        this.$vs.loading()
        this.$http.post('codifiedFoundProperties-filter/', {siteNew, domain, familyNew})
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
  ...
  methods: {
    ...
    Rech () {
      if (this.codeBien !== '') {
        ...
        this.$http.post('codifiedFoundProperties-filter/', { q })
          .then((response) => {
            this.recipients = response.data.results
            this.$vs.loading.close()
          })
    ...
    deleteData (id) {
      this.$vs.dialog({
        ...
        accept: async () => {
          this.$vs.loading()
          this.$http.delete(`propertiesCodification/${id}/`)
            .then(response => {
    ...
    getAllRecipients () {
      this.$vs.loading()
      this.$http.get('propertiesCodification/')
        .then((response) => {
          this.verif_filter = false
          this.recipients = response.data.results
          this.repNext = `${str}propertiesCodification/?limit=100&offset=100`
    ...
    getAllfiter () {
      this.$http.post('codifiedFoundProperties-filter/', {
        regionNew: this.region,
        siteNew:this.site,
        domain : this.domaine,
        familyNew: this.famille})
