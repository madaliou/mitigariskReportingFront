  ...
  watch: {
    famille (value) {
      ...
      if (value) {
        ...
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', { familyNew, domain, siteNew, regionNew   })
          .then((response) => {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', { domain, siteNew, regionNew   })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    domaine (value) {
      ...
      if (value) {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', { domain, familyNew, siteNew, regionNew  })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const siteNew = this.site
        const regionNew = this.region
        this.$http.post('labeledProperties-filter/', { familyNew, siteNew, regionNew  })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    site (value) {
      ...
      if (value) {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', { siteNew, domain, familyNew, regionNew })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', { domain, familyNew, regionNew })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    region (value) {
      ...
      if (value) {
        ...
        const familyNew = this.famille
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', { regionNew, siteNew, domain, familyNew})
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const familyNew = this.famille
        this.$vs.loading()
        this.$http.post('labeledProperties-filter/', {siteNew, domain, familyNew})
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
  ...
  methods: {
    ...
    Rech () {
      if (this.codeBien !== '') {
        ...
        this.$http.post('labeledProperties-filter/', { q })
          .then((response) => {
            this.recipients = response.data.results
            this.$vs.loading.close()
          })
    ...
    deleteData (id) {
      this.$vs.dialog({
        ...
        accept: async () => {
          this.$vs.loading()
          this.$http.delete(`labeledProperties/${id}/`)
            .then(response => {
    ...
    getAllRecipients () {
      this.$vs.loading()
      this.$http.get('labeledProperties/')
        .then((response) => {
          this.verif_filter = false
          this.recipients = response.data.results
          this.repNext = `${str}labeledProperties/?limit=100&offset=100`
    ...
    getAllfiter () {
      this.$http.post('labeledProperties-filter/', {
        regionNew: this.region,
        siteNew:this.site,
        domain : this.domaine,
        familyNew: this.famille})
