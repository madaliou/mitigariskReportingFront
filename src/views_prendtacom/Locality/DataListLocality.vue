  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" pagination :max-items="itemsPerPage" search :data="members">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="amount">Nom de la localité</vs-th>
        <vs-th>Action</vs-th>
      </template>
      ...
      <template slot-scope="{data}">
        ...
        <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
          <vs-td>
            <p class="product-name font-medium truncate">{{ tr.regionNew != null ? tr.regionNew.name : 'AUCUN'}}</p>
          </vs-td>
          <vs-td>
...
import DataViewSidebar from './DataViewSidebarLocality'
  ...
  methods: {
    ...
    deleteData (id) {
      ...
      this.$vs.dialog({
        ...
        accept: async () => {
          this.$vs.loading()
          this.$http.delete(`localitiesNew/${id}/`)
            .then(response => {
