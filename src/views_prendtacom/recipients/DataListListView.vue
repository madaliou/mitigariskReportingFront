  ...
  watch: {
    famille (value) {
      ...
      if (value) {
        ...
        this.$vs.loading()
        this.$http.post('filter/', { familyNew, domain, siteNew, regionNew   })
          .then((response) => {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('filter/', { domain, siteNew, regionNew   })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    domaine (value) {
      ...
      if (value) {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('filter/', { domain, familyNew, siteNew, regionNew  })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const siteNew = this.site
        const regionNew = this.region
        this.$http.post('filter/', { familyNew, siteNew, regionNew  })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    site (value) {
      ...
      if (value) {
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('filter/', { siteNew, domain, familyNew, regionNew })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const regionNew = this.region
        this.$vs.loading()
        this.$http.post('filter/', { domain, familyNew, regionNew })
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
    ...
    region (value) {
      ...
      if (value) {
        ...
        const familyNew = this.famille
        this.$vs.loading()
        this.$http.post('filter/', { regionNew, siteNew, domain, familyNew})
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
        ...
        const familyNew = this.famille
        this.$vs.loading()
        this.$http.post('filter/', {siteNew, domain, familyNew})
          .then((response) => {
            if (response.data.length !== 0) {
              this.recipients = response.data.results
              this.nextPage = str + (response.data.next).substr(37)
  ...
  methods: {
    ...
    deleteData (id) {
      this.$vs.dialog({
        ...
        accept: async () => {
          this.$vs.loading()
          this.$http.delete(`propertiesNew/${id}/`)
            .then(response => {
    ...
    getAllRecipients () {
      this.$vs.loading()
      this.$http.get('propertiesNew/')
        .then((response) => {
          this.verif_filter = false
          this.recipients = response.data.results
          this.repNext = `${str}propertiesNew/?limit=100&offset=100`
